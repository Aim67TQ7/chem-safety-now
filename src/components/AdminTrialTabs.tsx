              ...
              <TableCell>
                <div className="space-y-1">
                  ...
                  {facility.trial_days_remaining !== null && (
                    <div className={`text-xs ${facility.trial_days_remaining <= 0 ? 'text-red-600 font-medium' : 'text-gray-500'}`}>
                      {facility.trial_days_remaining <= 0 
                        ? `Expired ${Math.abs(facility.trial_days_remaining)} days ago`
